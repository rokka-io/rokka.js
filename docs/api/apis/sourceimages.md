...
```ts
contentCredentials(organization, hash): Promise<ContentCredentialsResponse>;
```
...
You can also search for it, see [list](#list). Note that the search values
...
`Promise`\<[`ContentCredentialsResponse`](#contentcredentialsresponse)\>

Promise resolving to the source image with refreshed content credentials
...
| ------ | ------ | ------ |
| `organization` | `string` | Organization name |
| `params` | [`SearchQueryParams`](#searchqueryparams) | Query string params (limit, offset, sort and search). Search values always have to be strings, `'true'` and not `true` |
...
| ------ | ------ | ------ | ------ |
| <a id="property-body"></a> `body` | [`SourceimageWithStaticMetadata`](#sourceimagewithstaticmetadata) | `RokkaResponse.body` | - |
...
- [`SourceimageWithStaticMetadata`](#sourceimagewithstaticmetadata)
...
| Property | Type | Overrides | Inherited from |
| ------ | ------ | ------ | ------ |
| <a id="property-body-1"></a> `body` | [`Sourceimage`](#sourceimage) | `RokkaResponse.body` | - |
...
| Property | Type | Overrides | Inherited from |
| ------ | ------ | ------ | ------ |
| <a id="property-body-2"></a> `body` | [`SourceimagesListResponseBody`](#sourceimageslistresponsebody) | `RokkaListResponse.body` | - |
| <a id="property-error-2"></a> `error?` | `any` | - | `RokkaListResponse.error` |
| <a id="property-message-2"></a> `message?` | `string` | - | `RokkaListResponse.message` |
| <a id="property-response-2"></a> `response` | `Response` | - | `RokkaListResponse.response` |
| <a id="property-statuscode-2"></a> `statusCode` | `number` | - | `RokkaListResponse.statusCode` |
| <a id="property-statusmessage-2"></a> `statusMessage` | `string` | - | `RokkaListResponse.statusMessage` |
...
| Property | Type | Overrides | Inherited from |
| ------ | ------ | ------ | ------ |
| <a id="property-binary_hash-1"></a> `binary_hash` | `string` | - | [`Sourceimage`](#sourceimage).[`binary_hash`](#property-binary_hash) |
| <a id="property-created-1"></a> `created` | `string` | - | [`Sourceimage`](#sourceimage).[`created`](#property-created) |
| <a id="property-deleted-2"></a> `deleted?` | `boolean` | - | [`Sourceimage`](#sourceimage).[`deleted`](#property-deleted-1) |
| <a id="property-dynamic_metadata-1"></a> `dynamic_metadata?` | [`MetaDataDynamic`](#metadatadynamic) | - | [`Sourceimage`](#sourceimage).[`dynamic_metadata`](#property-dynamic_metadata) |
| <a id="property-format-1"></a> `format` | `string` | - | [`Sourceimage`](#sourceimage).[`format`](#property-format) |
| <a id="property-hash-1"></a> `hash` | `string` | - | [`Sourceimage`](#sourceimage).[`hash`](#property-hash) |
| <a id="property-height-1"></a> `height` | `number` | - | [`Sourceimage`](#sourceimage).[`height`](#property-height) |
| <a id="property-link-1"></a> `link` | `string` | - | [`Sourceimage`](#sourceimage).[`link`](#property-link) |
| <a id="property-mimetype-1"></a> `mimetype` | `string` | - | [`Sourceimage`](#sourceimage).[`mimetype`](#property-mimetype) |
| <a id="property-name-1"></a> `name` | `string` | - | [`Sourceimage`](#sourceimage).[`name`](#property-name) |
| <a id="property-opaque-1"></a> `opaque?` | `boolean` | - | [`Sourceimage`](#sourceimage).[`opaque`](#property-opaque) |
| <a id="property-organization-1"></a> `organization` | `string` | - | [`Sourceimage`](#sourceimage).[`organization`](#property-organization) |
| <a id="property-protected-2"></a> `protected?` | `boolean` | - | [`Sourceimage`](#sourceimage).[`protected`](#property-protected-1) |
| <a id="property-short_hash-1"></a> `short_hash` | `string` | - | [`Sourceimage`](#sourceimage).[`short_hash`](#property-short_hash) |
| <a id="property-size-1"></a> `size` | `number` | - | [`Sourceimage`](#sourceimage).[`size`](#property-size) |
| <a id="property-static_metadata-1"></a> `static_metadata?` | [`StaticMetadata`](#staticmetadata) | [`Sourceimage`](#sourceimage).[`static_metadata`](#property-static_metadata) | - |
| <a id="property-user_metadata-1"></a> `user_metadata?` | [`MetaDataUser`](#metadatauser) | - | [`Sourceimage`](#sourceimage).[`user_metadata`](#property-user_metadata) |
| <a id="property-width-1"></a> `width` | `number` | - | [`Sourceimage`](#sourceimage).[`width`](#property-width) |
...
| Property | Type |
| ------ | ------ |
| <a id="property-content_credentials"></a> `content_credentials?` | [`ContentCredentials`](#contentcredentials-1) |
...
```ts
type ContentCredentials = object;
```
